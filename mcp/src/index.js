...
const tools = [
    {
        ...
        description: 'Connect to a MicroPython device. Use "ws" with a URL for WebSocket, "vm" for the built-in virtual device. USB and Bluetooth require the user to click the connect button in the browser. Non-blocking; use get_status to check when ready.',
        schema: {
...
mcp.tool(
    ...
    async ({ port_path }) => {
        ...
        try {
            ...
            bridge.call('connect_device', { type: 'ws', url: wsUrl }).catch(() => {})
            return textResult({
                url: wsUrl,
                ok: true,
